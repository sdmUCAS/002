...
class InstrumentsControllerTest < ActionController::TestCase
  ...
  test "should create instrument" do
    assert_difference('Instrument.count') do
      post :create, instrument: { description: @instrument.description, image_url: @instrument.image_url, name: @instrument.name, price: @instrument.price, type_name: @instrument.type_name }
    end
  ...
  test "should update instrument" do
    patch :update, id: @instrument, instrument: { description: @instrument.description, image_url: @instrument.image_url, name: @instrument.name, price: @instrument.price, type_name: @instrument.type_name }
    assert_redirected_to instrument_path(assigns(:instrument))
  end
